...
class AvailabilityClassifier(BaseClassifier):
    ...
    def _is_status_metric(self, metric_name: str) -> bool:
        ...
        status_patterns = ["_status", "_state", "_condition", "_mode"]
    ...
    def _is_probe_metric(self, metric_name: str) -> bool:
        ...
        probe_patterns = ["probe_success", "probe_duration", "healthcheck", "liveness", "readiness", "startup"]
    ...
    def _classify_health_metric(self, metric_name: str, _metadata: Optional[dict[str, Any]]) -> ClassificationResult:
    ...
    def _classify_status_metric(self, metric_name: str, _metadata: Optional[dict[str, Any]]) -> ClassificationResult:
        """Classify status/state metric for availability SLI."""

        positive_patterns = ["status", "state", "condition", "mode"]
    ...
    def _classify_probe_metric(self, metric_name: str, _metadata: Optional[dict[str, Any]]) -> ClassificationResult:
        """Classify probe metric for availability SLI."""

        positive_patterns = ["probe", "success", "healthcheck", "liveness", "readiness", "startup"]
