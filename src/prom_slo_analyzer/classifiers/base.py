...
class BaseClassifier(ABC):
    ...
    def batch_classify(self, metrics: List[str], metadata_map: Optional[Dict[str, Dict[str, Any]]] = None) -> List[ClassificationResult]:
    ...
    def _calculate_confidence(self, metric_name: str, positive_patterns: List[str], negative_patterns: List[str] = None) -> float:
