...
class PromQLValidator:
    ...
    def __init__(self):
        ...
        self._function_names = {
            ...
            'histogram_quantile', 'avg_over_time', 'max_over_time',
            'min_over_time', 'count_over_time', 'stddev', 'stdvar',
            'topk', 'bottomk', 'sort', 'sort_desc', 'abs', 'ceil',
            'floor', 'round', 'ln', 'log2', 'log10', 'exp', 'sqrt',
            'time', 'timestamp', 'vector', 'scalar', 'clamp_max',
            'clamp_min', 'changes', 'deriv', 'predict_linear',
            'holt_winters', 'irate', 'resets', 'delta'
        }
