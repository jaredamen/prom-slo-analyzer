...
from src.prom_slo_analyzer.client import PrometheusClient
from src.prom_slo_analyzer.discovery import ServiceMetrics
from src.prom_slo_analyzer.classifiers.base import ClassificationResult, SLIType
...
def mock_prometheus_client(sample_metric_names):
    ...
    def mock_get_metadata(metric_name: str):
        metadata_map = {
            "api_gateway_requests_total": {
                "type": "counter",
                "help": "Total number of HTTP requests to API gateway"
            },
            "api_gateway_request_duration_seconds_bucket": {
                "type": "histogram", 
...
def sample_services():
    ...
    return [
        ...
        ServiceMetrics(
            ...
            namespace="staging",
            metrics=[
                "incomplete_service_requests_total"  # Only throughput, missing latency/errors
            ],
            labels={}
        ),
        ServiceMetrics(
            ...
            metrics=[
                "no_sli_service_build_info",  # Not suitable for SLIs
                "no_sli_service_config_hash"
            ],
            labels={}
        )
    ]
...
@pytest.fixture
def all_sample_classifications(sample_latency_classifications, sample_error_classifications, sample_throughput_classifications):
